...
<div className="absolute roadmap-bg sm:w-[100%] md:w-screen sm:h-[255%]  md:h-[240%] xl:w-screen xl:h-[190%] lg:h-[188%] lg:w-screen 2xl:w-screen 2xl:h-[160%] " id="poker">
        ...
        <div id="team" className="absolute sm:my-[222%] sm:w-full md:w-screen md:my-[165%]  lg:w-screen lg:my-[125%] xl:w-screen 2xl:w-screen team-grid 2xl:my-[120%] xl:my-[145%]">
                ...
                <img className=" sm:w-[50%] sm:pb-[30%] sm:left-[15%] sm:relative md:w-[50%] md:pb-[35%] md:mx-[30%] lg:w-[50%] lg:pb-[35%] lg:mx-[30%] 2xl:w-[50%] 2xl:mx-[22%] xl:w-[50%] xl:mx-[22%] " src="./assets/blah.svg" alt="grid" />
