...
function Roadmap() {
        ...
        return (
                ...
                <div className="   absolute roadmap-bg sm:h-[120%]   md:w-screen xl:w-screen lg:w-screen  2xl:h-[330%] ">
                    <img className=" object-cover opacity-100 z-50 sm:h-[50%]  " src="./assets/texture-1-min.png" alt="texture" />
                    ...
                    <div id="roadmap" className="absolute box-1 sm:w-[80%] sm:h-[18%] sm:mx-[10%] sm:top-[18.5%] md:w-[70%] md:mx-[15%] md:h-[13.5%] md:top-[25%]   border lg:w-[70%] lg:h-[10%] lg:top-[25%] lg:mx-[17%] xl:w-[70%] 2xl:w-[70%] 2xl:h-[10%] 2xl:top-[22%] 2xl:mt-40 2xl:mx-[15.9%] xl:h-[10%] xl:top-[29.2%]  div-road   z-10   xl:mx-[13.9%]">
                    ...
                    <div className="">
                            <img className=" opacity-100 z-100 xl:my-[0.01%]   " src="./assets/texture-2-min.png" alt="texture" />
        ...
        <h4 className="dummy-1 sm:text-[1.3em] sm:pb-[0.5%] md:text-[1.3em]   xl:my-[2%] 2xl:my-[4%]">Poker Events & Building</h4>
          ...
          <div className=" ">
                <img className=" opacity-100 z-100 xl:my-[0.01%]  " src="./assets/curve-texture-min.png" alt="texture" />
